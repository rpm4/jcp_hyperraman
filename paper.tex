...
\begin{figure*}[!htbp]
	...
	\caption{Contributions of $A, B$ (\autoref{ABterms_DR}) to HDFG spectrum for a simple two harmonic well system.
		...
		The vibrational states on the $|g)$ and $|e)$ manifolds are spaced 1600 cm$^{-1}$ apart, with the vibronic states $\ket{e,\tilde{v}'}$ given linewidths of 400 cm$^{-1}$ and $\hbar \omega_{eg}$ = 30000 cm$^{-1}$.
