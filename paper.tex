...
In \autoref{steadystate}, we first identify the selection rules that drives HDFG through the Placzek approximation. 
...
The selection rules of doubly resonant HDFG (DR-HDFG) are identified through the Herzberg-Teller dipole expansion.
...
% DDK: the problem is "applications" does not fit well into the story we have framed in the intro.  
% DDK: what about "comparisons of HDFG with other spectroscopies"?
% also, can some of these things really be called applications?  is site-selectivity an application?  is turning a v-SFG measurement into a HDFG measurement an application?
...
% this whole argument is we only need two colors...why is there a whole section on this?
