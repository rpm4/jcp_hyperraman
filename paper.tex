...
While the Placzek treatment provides the source of vibrationally HDFG output, it does not predict the behavior of $\beta_{ijk}$ as $\omega_2 + \omega_3$ is changed.
