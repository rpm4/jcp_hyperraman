...
Note that in the limit of complete potential energy surface overlap ($\xi \rightarrow 0$), $A$ vanishes as $\lim_{\xi \rightarrow 0} \langle 1 | 0 \rangle = 0$ for potential wells with identical curvature.
