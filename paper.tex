...
\begin{figure*}[!htbp]
	...
	\caption{Contributions of $A, B$ (\autoref{ABterms_DR}) to HDFG spectrum for a simple two harmonic well system.
		...
		The vibrational states on the $|g)$ and $|e)$ manifolds are spaced 2200 cm$^{-1}$ apart, with the vibronic states $\ket{e,\tilde{v}'}$ given linewidths of 700 cm$^{-1}$ and $\hbar \omega_{eg}$ = 30000 cm$^{-1}$.
...
The belief arises from the approximation $\abs{\omega_{e\tilde{v}',gv} - 2\omega_2} \gg 2\Gamma_{e\tilde{v}',gv}$, which then removes $A$ through a closure relationship.\cite{Neddersen1989}
...
\begin{table}[!htbp]
	...
	\begin{ruledtabular}
		\begin{tabular}{cccc}
			...
			$B_2$ 
			& $\mel{1}{Q}{\tilde{0}} \langle \tilde{0} | 0 \rangle = 0.55$  
