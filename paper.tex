...
These methods have been used to understand vibronic coupling in a variety of molecular systems and, albeit different selection rules, serve as 2D pump-probe type analogues to the hyper-Raman-based spectroscopies discussed here.\cite{Courtney2015, Gaynor2018, Arsenault2020, HuangFu2023}
...
The Franck-Condon and Herzberg-Teller integrals can manipulate interference in the total output spectrum as a function of offset (Figure S2).
When the offset is inverted about the origin ($\Delta \rightarrow -\Delta$), 

However, the main source of interference in the HDFG spectra arises from the sign of the molecular parameters. 
...
Inverting the sign of one parameter eliminates the interference and restores the expected, purely Lorentzian lineshape.


*orientational averaging
*changing one trivially fixes interference (cf plot above)
*in SI, put examples
