...
The $A$ and $B$ coefficients, where $B = B_1 + B_2$, following closure over $\ket{n}$ are written as:
\begin{widetext}
...
This selection rule is imposed by the dipole transition in HDFG. %todo: note this is the OPPOSITE of hyper raman
