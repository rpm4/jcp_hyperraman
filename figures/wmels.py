...
if timeorderedwmel:
    fig = WMEL.Artist([4,1], [0, 0.2, 0.4, 0.8, 1], state_names=("$\mathsf{| g\\rangle}$",
                                                                   "$\mathsf{|m\\rangle}$", 
                                                                   "$\mathsf{|v\\rangle}$",
                                                                   "$\mathsf{|n\\rangle}$",
                                                                   "$\mathsf{|p\\rangle}$"), number_of_interactions=5, state_font_size=9, state_text_buffer = 0.6, virtual = [1,3,4])
    ...
    fig.add_arrow([2,0], 0, [0,2], kind='ket', color="k", label = "$\mathsf{2}$", head_length = 0.075)
    fig.add_arrow([2,0], 1, [2,4], kind='ket', color="k", label = "$\mathsf{3}$", head_length = 0.075)
    ...
    fig.add_arrow([3,0], 0, [0,2], kind='ket', color="k", label = "$\mathsf{2}$", head_length = 0.075)
    fig.add_arrow([3,0], 1, [2,4], kind='ket', color="k", label = "$\mathsf{3}$", head_length = 0.075)
    ...
    fig.label_columns(['$(\mathsf{a})$','$(\mathsf{b})$', '$(\mathsf{c})$', '$(\mathsf{d})$'], font_size = 10)
