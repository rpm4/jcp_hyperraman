...
if compar:
    ...
    fig.add_arrow([3,0], 0, [2,3], kind='bra', color="k", label = "$\mathsf{2}$", head_length = 0.075)
    fig.add_arrow([3,0], 1, [3,1], kind='bra', color="k", label = "$\mathsf{3}$", head_length = 0.075)
    fig.add_arrow([3,0], 2, [0,2], kind='ket', color="k", label = "$\mathsf{4}$", head_length = 0.075)    
