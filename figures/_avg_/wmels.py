...
if test:
    ...
    fig0.label_columns(['$\mathsf{DFG}$','$\mathsf{SFG}$'], font_size = 9)
    ...
    fig3 = WMEL.Artist([2,1], [0, 0.2, 0.35, 0.8, 1], state_names=("$\mathsf{| g\\rangle}$",
                                                                    "$\mathsf{|v\\rangle}$", 
                                                                    "$\mathsf{|v'\\rangle}$",
                                                                    "$\mathsf{|v'\\rangle}$",
                                                                    "$\mathsf{|e\\rangle}$"), number_of_interactions=5, state_font_size=9, state_text_buffer = 0.6)
    ...
    fig4 = WMEL.Artist([1,1], [0, 0.2, 0.4, 0.6, 0.85, 1], state_names=("$\mathsf{|g\\rangle}$",
                                                                    "$\mathsf{|v\\rangle}$", 
                                                                    "$\mathsf{|m\\rangle}$",
                                                                    "$\mathsf{|n\\rangle}$",
                                                                    "$\mathsf{|e'\\rangle}$",
                                                                    "$\mathsf{|e\\rangle}$"), number_of_interactions=5, state_font_size=9, state_text_buffer = 0.6, virtual = [2, 3])

    fig4.add_arrow([0,0], 0, [0,2], kind='ket', color="k", label = "$\mathsf{1}$", head_length = 0.075)
    fig4.add_arrow([0,0], 0, [2,4], kind='ket', color="k", label = "$\mathsf{1}$", head_length = 0.075)
    fig4.add_arrow([0,0], 1, [4,1], kind='ket', color="k", label = "$\mathsf{2}$", head_length = 0.075)
    fig4.add_arrow([0,0], 2, [1,3], kind='ket', color="k", label = "$\mathsf{3}$", head_length = 0.075)    
    fig4.add_arrow([0,0], 2, [3,5], kind='ket', color="k", label = "$\mathsf{3}$", head_length = 0.075)
    fig4.add_arrow([0,0], 3, [5,0], kind='out', color="blue", label = "$\mathsf{4}$", head_length = 0.075)
